...
public class Blocks {
	...
	public static void loadTextures() {
		...
		MotherRenderer.loadTexture("none", none);
		MotherRenderer.loadTexture("orangeDiffuse", "block_face_orange");
		MotherRenderer.loadTexture("stoneDiffuse", "stone");
		MotherRenderer.loadTexture("grassDiffuse", "grass");
	}
}
